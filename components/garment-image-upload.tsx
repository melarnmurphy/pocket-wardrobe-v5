...
export function GarmentImageUpload({
  ...
  return (
    <form
      action={formAction}
      className="border-t border-b border-[var(--line)] py-5"
    >
      ...
      <div
        className={`relative mt-4 overflow-hidden border border-dashed transition-colors ${
          previewUrl
        ...
        {previewUrl ? (
          <div className="relative">
            <Image
              ...
              height={800}
              unoptimized
              className="h-72 w-full object-contain bg-[rgba(242,236,227,0.45)]"
            />
