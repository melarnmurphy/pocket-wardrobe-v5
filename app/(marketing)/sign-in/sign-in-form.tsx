      ...
      <section className={styles.authColumn}>
        ...
        {isCreate ? (
          <form action={signUpWithPasswordAction} className={styles.authForm} data-1p-ignore="true">
            ...
            <Field label="your name" name="name" autoComplete="off" data-1p-ignore data-op-ignore placeholder="your name" defaultValue={name} required />
            <div className={styles.authTwoUp}>
              <Field label="date of birth" name="date_of_birth" type="date" autoComplete="off" data-1p-ignore data-op-ignore defaultValue={dateOfBirth} required />
