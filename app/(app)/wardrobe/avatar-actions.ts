...
export async function uploadAvatarPhotoAction(formData: FormData): Promise<AvatarActionResult> {
  try {
    ...
    return {
      status: "error",
      message: userFacingError(error, "we couldn't save that avatar photo. try again.")
    };
  }
}
...
export async function generateAvatarPhotoAction(formData: FormData): Promise<AvatarActionResult> {
  try {
    ...
    return {
      status: "error",
      message: userFacingError(error, "we couldn't generate your avatar. try again.")
    };
  }
}
...
export async function saveAvatarLayoutAction(formData: FormData): Promise<AvatarActionResult> {
  try {
    ...
    return {
      status: "error",
      message: userFacingError(error, "we couldn't save your avatar layout. try again.")
    };
  }
}
...
export async function saveAvatarMeasurementsAction(
  ...
  try {
    ...
    return {
      status: "error",
      message: userFacingError(error, "we couldn't save those measurements. try again.")
    };
  }
}
