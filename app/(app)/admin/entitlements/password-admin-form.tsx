    ...
    <form action={formAction} className="pw-panel-soft space-y-5 p-6">
      <div>
        ...
        <h2 className="mt-3 text-2xl font-semibold tracking-[-0.03em]">
          Set a user password directly
        </h2>
        <p className="mt-3 max-w-2xl text-sm leading-6 text-[var(--muted)]">
          This uses the Supabase Auth admin API and bypasses email rate limits. It is intended for
          admin recovery and local setup only.
        </p>
      </div>
