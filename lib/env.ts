...
const serverEnvSchema = publicEnvSchema.extend({
  ...
  OPENROUTER_INGESTION_MODEL: optionalString,
  OPENROUTER_INGESTION_FALLBACK_MODEL: optionalString,
...
export function getServerEnv(): ServerEnv {
  return serverEnvSchema.parse({
    ...
    OPENROUTER_INGESTION_MODEL: process.env.OPENROUTER_INGESTION_MODEL,
    OPENROUTER_INGESTION_FALLBACK_MODEL: process.env.OPENROUTER_INGESTION_FALLBACK_MODEL,
